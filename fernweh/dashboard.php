                                    ...
                                    if($result){
                                        ...
                                        <div class="col-md-4">
                                                <div class="card" style="width: 18rem;">
                                                    <img src="./storyteller/images/<?php echo $image;?>" height="150" width="150" class="card-img-top" alt="...">
                                                    <div class="card-body">
                                                        <h5 class="card-title"><?=$post['title'];?></h5>
                                                        <h6 class="card-title"><?=$row['fname'] .' '. $row['lname'];?></h6>
                                                        <p class="card-text"><?=substr($post['post_content'],0,20);?> ...</p>
