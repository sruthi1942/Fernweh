...
$query = "UPDATE post SET title = '$title', content = '$ontent', image='$image',  location = '$location', category= '$category', update= $today WHERE id = $user_id";
...
echo "<script>alert('Post edit successful');</script";
